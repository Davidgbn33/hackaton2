 ...
 */
final class Version20230628161014 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE model (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE telephone (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, model_id INT DEFAULT NULL, ram_id INT DEFAULT NULL, memory_id INT DEFAULT NULL, network_id INT DEFAULT NULL, status_id INT DEFAULT NULL, cable_charger TINYINT(1) NOT NULL, estimated_price INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_450FF010A76ED395 (user_id), INDEX IDX_450FF01044F5D008 (brand_id), INDEX IDX_450FF0107975B7E7 (model_id), INDEX IDX_450FF0103366068 (ram_id), INDEX IDX_450FF010CCC80CB3 (memory_id), INDEX IDX_450FF01034128B91 (network_id), INDEX IDX_450FF0106BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
